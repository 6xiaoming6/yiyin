export const help: {
  ...
  {
    title: '输出文件名支持哪些内置变量？',
    desc: `在输出文件名的输入框中，可以使用以下变量来自定义输出文件名：
    <br><b>&#36;{filename}</b> - 原始文件名（不含扩展名）
    <br><b>&#36;{ext}</b> - 原始扩展名（如 ARW、JPG）
    <br><b>&#36;{date}</b> - 当前日期，格式 YYYYMMDD（如 20260531）
    <br><b>&#36;{time}</b> - 当前时间，格式 HHMMSS（如 143052）
    <br><b>&#36;{datetime}</b> - 日期+时间（如 20260531_143052）
    <br><b>&#36;{random}</b> - 6位随机字符串，用于避免重名
    <br>例如：&#36;{date}_&#36;{filename}_&#36;{random} → 20260531_DSC01234_k3x9a2.jpg`,
  },
  {
    title: '图片输出目录在什么地方？',
